...
#python3 cockroachDB_driver.py -u postgresql://naili:naili@localhost:26257/cs5424db?sslmode=require -p /opt/project_files/xact_files_A/.txt -w A >logs/python1.log &
