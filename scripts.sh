...
do
        ...
        python3 cockroachDB_driver.py -u postgresql://naili:naili@localhost:$server_ip/cs5424db?sslmode=require -p /opt/project_files_4/xact_files_A/$i.txt -w A >logs/python$i.log &
        i=$(($i+1))
done
