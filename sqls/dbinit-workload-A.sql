...
IMPORT INTO cs5424db.workloadA.warehouse
    CSV DATA ('http://localhost:3000/home/stuproj/cs4224p/temp/tasks/project_files_4/data_files/warehouse.csv')
...
IMPORT INTO cs5424db.workloadA.district
    CSV DATA ('http://localhost:3000/home/stuproj/cs4224p/temp/tasks/project_files_4/data_files/district.csv')
    WITH delimiter = e',', nullif = 'null';
...
IMPORT INTO cs5424db.workloadA.customer
    CSV DATA ('http://localhost:3000/home/stuproj/cs4224p/temp/tasks/project_files_4/data_files/customer.csv')
    WITH delimiter = e',', nullif = 'null';
...
IMPORT INTO cs5424db.workloadA.order_ori (O_W_ID, O_D_ID, O_ID, O_C_ID, O_CARRIER_ID, O_OL_CNT, O_ALL_LOCAL, O_ENTRY_D)
    CSV DATA ('http://localhost:3000/home/stuproj/cs4224p/temp/tasks/project_files_4/data_files/order.csv')
    WITH delimiter = e',', nullif = 'null';
...
IMPORT INTO cs5424db.workloadA.item (I_ID,I_NAME,I_PRICE,I_IM_ID,I_DATA)
    CSV DATA ('http://localhost:3000/home/stuproj/cs4224p/temp/tasks/project_files_4/data_files/item.csv')
    WITH delimiter = e',', nullif = 'null';
...
IMPORT INTO cs5424db.workloadA.stock
    CSV DATA ('http://localhost:3000/home/stuproj/cs4224p/temp/tasks/project_files_4/data_files/stock.csv')
    WITH delimiter = e',', nullif = 'null';
...
IMPORT INTO cs5424db.workloadA.order_line (ol_w_id, ol_d_id, ol_o_id, ol_number, OL_I_ID, OL_DELIVERY_D, OL_AMOUNT, OL_SUPPLY_W_ID, OL_QUANTITY, OL_DIST_INFO)
    CSV DATA ('http://localhost:3000/home/stuproj/cs4224p/temp/tasks/project_files_4/data_files/order-line.csv')
    WITH delimiter = e',', nullif = 'null';
